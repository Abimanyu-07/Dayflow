...
async function main() {
    ...
    // 1. Seed Departments
    const engineering = await prisma_1.prisma.departments.upsert({
    ...
    const hrDept = await prisma_1.prisma.departments.upsert({
    ...
    const salesDept = await prisma_1.prisma.departments.upsert({
    ...
    // 2. Seed Leave Types
    const paidLeave = await prisma_1.prisma.leave_types.upsert({
    ...
    const sickLeave = await prisma_1.prisma.leave_types.upsert({
    ...
    const casualLeave = await prisma_1.prisma.leave_types.upsert({
    ...
    const adminPasswordHash = await password_1.PasswordUtil.hash('Admin@1234');
    const adminUser = await prisma_1.prisma.users.upsert({
    ...
    await prisma_1.prisma.employees.upsert({
    ...
    const empPasswordHash = await password_1.PasswordUtil.hash('Employee@1234');
    const empUser = await prisma_1.prisma.users.upsert({
